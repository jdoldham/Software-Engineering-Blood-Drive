...
function logIn(event) {
  $.ajax({
    type: 'POST',
    url: 'http://localhost:3000/users/login/' + $('#logIn fieldset input#email').val() + '/' + $('#logIn fieldset input#pass').val()
...
function testSession() {
  $.ajax({
    type: 'POST',
    url: 'http://localhost:3000/users/login/' + 'joldham@uark.edu' + '/' + '123'
  });
}; 
